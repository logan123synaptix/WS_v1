##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.9.0-B19] date: [Wed Jul 29 10:51:25 ICT 2026] 
##########################################################################################################################
...
C_INCLUDES += -I$(SYNAPTIX_DIR)/app \
			  ...
			  -I$(SYNAPTIX_DIR)/app/user/gps_fix_cache \
			  ...
			  -I$(SYNAPTIX_DIR)/components/peripherals/pwm_sw \
#USB tiny
